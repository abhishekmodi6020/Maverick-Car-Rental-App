...
public class CalculateAmount extends AppCompatActivity {
    ...
    public static double[] getWorkingDaysBetweenTwoDates(Date startDate, Date endDate,SQLiteDatabase mDb,String carName_string,String WeekDayRate,String WeekEndRate,String WeekRate) {
        ...
        int total_days = workDays + weekEnd;
        if (total_days >= 7){
            int no_of_weeks = total_days/7;
        ...
        double IntWeekRate = Double.parseDouble(WeekRate);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lgbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(CalculateAmount.this, MainActivity.class);
                startActivity(i);
            }
        });
    }
